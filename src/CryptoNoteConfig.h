...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x3f3a18;
...
const uint64_t MONEY_SUPPLY                                  = UINT64_C(16091983000000000000);
...
const char     CRYPTONOTE_NAME[]                             = "sashacoin";
